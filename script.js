const i18n = {
  zh: {
    pageTitle: "王明课题组 | 超分子化学",
    pageDesc:
      "王明课题组（吉林大学）聚焦超分子化学，研究金属有机笼的精准构筑及叠层超分子的性质与功能。",
    brandCn: "王明课题组",
    ...
    heroTitle: "王明课题组",
    heroDesc:
      "面向分子精准组装前沿，聚焦金属有机笼的精准构筑与叠层超分子的性质与功能，建立“结构-组装-功能”一体化研究体系。",
    heroBtn1: "查看研究成果",
    heroBtn2: "加入我们",
    stat1: "发表论文（持续更新）",
    stat2: "在研项目（持续更新）",
    ...
    aboutCard1Desc: "王明课题组（吉林大学）",
    aboutCard2Title: "主要研究领域",
    aboutCard2Desc: "超分子化学",
    aboutCard3Title: "核心研究方向",
    aboutCard3Desc: "金属有机笼的精准构筑及叠层超分子的性质与功能",
    aboutCard4Title: "研究关键词",
    aboutCard4Desc: "自组装 · 主客体化学 · 功能超分子材料 · 分子识别",
    researchTitle: "研究方向",
    researchSub: "从分子设计到功能验证的闭环研究。",
    research1Title: "01 · 金属有机笼的精准构筑",
    research1Desc: "通过配体工程与金属节点协同调控，实现尺寸、形貌与手性可编程构筑。",
    research2Title: "02 · 叠层超分子有序组装",
    research2Desc: "利用多重弱相互作用驱动层级堆叠，构建高稳定性与可响应性超分子体系。",
    ...
    tabConferences: "会议",
    newsTitle: "新闻与动态",
    newsSub: "建议每月更新 1-3 条，保持网站活跃度。",
    contactTitle: "联系方式与社交媒体",
    contactSub: "以下为推荐字段，可替换为真实信息。",
    contactCard1Title: "联系信息",
    contactMail: "邮箱：wangming_lab@jlu.edu.cn",
    contactPhone: "电话：+86-431-0000-0000",
    contactAddr: "地址：吉林省长春市吉林大学（示例）",
    contactCard2Title: "社交媒体/平台",
    wechat: "微信公众号（二维码）",
    contactCard3Title: "招生与合作",
    contactCard3Desc: "欢迎博士后、博士/硕士研究生及联合培养学生加入，支持跨学科合作。",
  ...
  en: {
    ...
    pageDesc:
      "Wang Ming Laboratory at Jilin University focuses on supramolecular chemistry, including precise construction of metal-organic cages and stacked supramolecular functions.",
    ...
    aboutCard2Desc: "Supramolecular Chemistry",
    aboutCard3Title: "Core Direction",
    aboutCard3Desc: "Precise construction of metal-organic cages and properties/functions of stacked supramolecules",
    aboutCard4Title: "Keywords",
    aboutCard4Desc: "Self-assembly · Host-guest Chemistry · Functional Supramaterials · Molecular Recognition",
    ...
    newsSub: "Recommended update frequency: 1-3 items per month.",
    contactTitle: "Contact & Social",
    contactSub: "Recommended fields below can be replaced with real information.",
    contactCard1Title: "Contact Info",
    contactMail: "Email: wangming_lab@jlu.edu.cn",
    contactPhone: "Phone: +86-431-0000-0000",
    contactAddr: "Address: Jilin University, Changchun, Jilin, China (sample)",
    contactCard2Title: "Platforms",
    wechat: "WeChat Official Account (QR Code)",
    contactCard3Title: "Recruitment & Collaboration",
    contactCard3Desc: "We welcome postdocs, PhD/MSc students, and interdisciplinary collaborators.",
...
const outputData = {
  papers: [
    ...
    {
      date: "2023",
      zh: { title: "Dislocated Bilayer MOF Enables High-Selectivity Photocatalytic Reduction of CO2 to CO", desc: "Advanced Materials, 2023" },
      en: { title: "Dislocated Bilayer MOF Enables High-Selectivity Photocatalytic Reduction of CO2 to CO", desc: "Advanced Materials, 2023" }
    },
    {
      date: "2023",
      zh: { title: "Sandwich-like Heterochromophore Metallo-Supramolecules Based on Dense Chromophore Arrangements", desc: "2023" },
      en: { title: "Sandwich-like Heterochromophore Metallo-Supramolecules Based on Dense Chromophore Arrangements", desc: "2023" }
    },
    {
      date: "2023",
      zh: { title: "Nitrogen Atom Induced Contrast Effect on the Mechanofluorochromic...", desc: "Chemistry - An Asian Journal, 2023" },
    ...
    {
      date: "2022",
      zh: { title: "Porous Assembly of Metallo-Supramolecule and Polyoxometalate via Ionic...", desc: "Chinese Journal of Chemistry, 2022" },
      en: { title: "Porous Assembly of Metallo-Supramolecule and Polyoxometalate via Ionic...", desc: "Chinese Journal of Chemistry, 2022" }
    },
    {
      date: "2022",
    ...
    {
      date: "2021",
      zh: { title: "Self-Assembly of Metallo-Supramolecules with Dissymmetrical Ligands...", desc: "2021" },
...
function renderNews() {
  ...
  list.innerHTML = newsData
    .map((item) => {
      const d = item[currentLang];
      return `<article class="news-item"><p class="meta">${item.date}</p><h4>${d.title}</h4><p>${d.desc}</p></article>`;
    })
    .join("");
}
...
function applyLanguage() {
  applyStaticText();
  renderMembers();
  renderOutputs(currentOutputType);
  renderNews();
  syncLanguageButtons();
}
